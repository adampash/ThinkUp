...
// class EOYBiggestFansInsight extends CriteriaMatchInsightPluginParent implements InsightPlugin {
    ...
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        ...
        if ($should_generate_insight) {
            ...
            $fans = $fav_dao->getUsersWhoFavoritedMostOfYourPosts($instance->network_user_id,
                $instance->network, Utils::daysSinceJanFirst());
            ...
            $url .= "u=".$instance->network_username."&n=".$network."&d=".$date.
                "&s=".$insight->slug;
            $url = urlencode($url);
