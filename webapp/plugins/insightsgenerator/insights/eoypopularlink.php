            ...
            $copy = array(
                'twitter' => array(
                    ...
                    'none' => array(
                        ...
                        'body' => "%username didn't share any links on Twitter this year. " .
                            "Crazy, %username!"
                    )
                ),
                'facebook' => array(
                    'normal' => array(
                        ...
                        'body' => "We laughed, we cried, we linked. These are the most " .
                            "popular links %username shared on Facebook in %year."
                    ),
                    'one' => array(
                        'headline' => "%username's most popular link on Facebook, %year",
                        'body' => "We laughed, we cried, we linked. This is the most " .
                            "popular link %username shared on Facebook in %year."
                    ),
                    'none' => array(
                        'headline' => "No links on Facebook?",
                        'body' => "%username didn't link to anything on Facebook this year. " .
