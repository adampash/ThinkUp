...
class EOYMostTalkativeDayInsight extends InsightPluginParent implements InsightPlugin {
    ...
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        if (Utils::isTest() || date("Y-m-d") == '2014-12-03') {
            ...
            $insight->slug = 'eoy_most_talkative';
            ...
            $copy = array(
                'twitter' => array(
                    'normal' => array(
                        ...
                        'body' => "%username tweeted <b>%total times on %talkative_date</b>, " .
                ...
                'facebook' => array(
                    'normal' => array(
                        ...
                        'body' => "%username posted to Facebook <b>%total times on " .
                        "%talkative_date</b>, more than any other day this year. " .
            ...
            $most_talkative_days = $this->getMostTalkativeDays($instance->network);
     ...
     */
    public function getMostTalkativeDays($network='twitter') {
