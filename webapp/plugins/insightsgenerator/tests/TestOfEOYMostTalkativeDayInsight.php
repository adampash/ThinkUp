...
class TestOfEOYMostTalkativeDayInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testMostTalkativeDay() {
        ...
        $most_talkative_days = $insight_plugin->getMostTalkativeDays('twitter');
    ...
    public function testTwitterNormalCase() {
        ...
        $this->assertEqual("@buffy tweeted <b>8 times on February 7</b>, more than " .
    ...
    public function testFacebookNormalCase() {
        ...
        $this->assertEqual("Buffy Summers posted to Facebook <b>8 times on February 7</b>" .
    ...
    public function testTwitterMultipleMatches() {
        ...
        $this->assertEqual("In the running for @buffy's most talkative day on " .
            "Twitter, $year, we've got a tie: @buffy tweeted <b>5 times on February 7, " .
            "March 7, and April 7</b> — more than on any other days this year. These are " .
    ...
    public function testFacebookMultipleMatches() {
        ...
        $this->assertEqual("In the running for Buffy Summers's most talkative day on " .
            "Facebook, $year, we've got a tie: Buffy Summers posted <b>5 times on February " .
            "7, March 7, and April 7</b> — more than on any other days this year. These " .
