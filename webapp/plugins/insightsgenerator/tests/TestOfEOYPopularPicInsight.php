...
class TestOfEOYPopularPicInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testGetScoredPics() {
        ...
        $builders[] = FixtureBuilder::build('posts', array('id'=>10, 'post_id'=>10,
            'author_user_id'=>$this->instance->author_id,
        ...
        $builders[] = FixtureBuilder::build('posts', array('id'=>12, 'post_id'=>12,
            ...
            'source'=>'web',
            'pub_date'=>"$year-02-07",
            'reply_count_cache'=>12, 'is_protected'=>false));
        ...
        $last_year_of_posts = $insight_plugin->getYearOfPosts($this->instance);

        $scored_pics = $insight_plugin->getScoredPics($last_year_of_posts);
        // $this->debug(Utils::varDumpToString($scored_pics));
        $sorted_pics = array(
            0 => array(12 => 60),
            1 => array(10 => 50)
        );
    ...
    public function testTwitterNormalCase() {
        ...
        $today = date ('Y-m-d');
        $result = $insight_dao->getInsight('eoy_popular_pic', $this->instance->id, $today);
