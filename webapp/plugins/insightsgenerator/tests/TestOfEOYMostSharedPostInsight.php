...
/**
 *
 * webapp/plugins/insightsgenerator/tests/TestOfEOYMostSharedPostInsight.php
 *
 * LICENSE:
 *
...
require_once THINKUP_ROOT_PATH. 'webapp/plugins/insightsgenerator/insights/eoymostsharedpost.php';

class TestOfEOYMostSharedPostInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testConstructor() {
        $insight_plugin = new EOYMostSharedPostInsight();
        $this->assertIsA($insight_plugin, 'EOYMostSharedPostInsight' );
    }
